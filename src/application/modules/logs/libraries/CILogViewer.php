...
class CILogViewer {
	...
	const CI_LOG_VIEW_FILE_PATH = "logs/logs_view.php";
	...
	private function init()
	{
		...
		$this->LOG_VIEW_FILE_PATH = rtrim($this->LOG_VIEW_FILE_FOLDER) . "CILogViewer.php/" . $this->LOG_VIEW_FILE_NAME;

//		echo $this->LOG_VIEW_FILE_FOLDER;
//		echo $this->LOG_VIEW_FILE_PATH;
//application/modules/logs/views
...
//
//		//$this->LOG_VIEW_FILE_FOLDER = VIEWPATH . "";
//		echo $this->LOG_VIEW_FILE_FOLDER;
